...
faker.locale = 'pt_BR';
  ...
  it('PF - Usado -Cenário com idade não elegível para seguro', () => {
  ...
  cy.get(el.CLIENTE.DTNASCIMENTO).type('15/02/1944{Esc}').should('have.value', '15/02/1944')

  cy.get(el.CLIENTE.CAMPO_TEL).type('61998350206').should('have.value', '(61) 9 9835-0206')
  cy.get(el.CLIENTE.CAMPO_EMAIL).clear()
  cy.get(el.CLIENTE.CAMPO_EMAIL).type(email).should('have.value', email)
  cy.get(el.CLIENTE.CAMPO_EMAIL).should('contain.value', '@')

  cy.get(el.CLIENTE.CAMPO_CEP).type('80250020{enter}')

  cy.get(el.CLIENTE.CAMPO_CEP).should('have.value', '80250-020')
 ...
 // cy.get(el.SIMULACAO.CHECK_SEGURO_PROTECAO_FINANCEIRA, { timeout: 80000 }).should('be.checked')
  ...
  cy.get(el.SIMULACAO.BTN_CONTRATAR_SEGUROS).contains('Contratar').should('be.visible').click({ force: true })
  ...
  cy.get(el.SIMULACAO.CLIENTE_DTNASCIMENTO).should('contain', '15/02/1944')
  cy.get(el.SIMULACAO.CLIENTE_CEP).should('contain', '80250-020')
  cy.get(el.SIMULACAO.CLIENTE_UF).should('contain', 'PR')
  ...
  //ComboUF
  cy.get(el.FICHA_CLIENTE.DP_COMBOUF, { timeout: 70000 }).click()//.type('DISTRITO FEDERAL')
  ...
  cy.get('.mat-option-text').contains('BRASÍLIA', { timeout: 80000 }).click({ force: true })
  cy.get(el.FICHA_CLIENTE.DP_NATURALIDADE, { timeout: 80000 }).should('contain', 'BRASÍLIA')
  cy.wait(1000)
  ...
  .click({ force: true })
  .type('424243519').should('have.value', '424243519')
  ...
  cy.get('.mat-option-text').contains('RIO DE JANEIRO', { timeout: 80000 }).click({ force: true })

  cy.get(el.FICHA_CLIENTE_DOCUMENTOS.DTEMISSAO).type('12/09/2005{Esc}')
  cy.get(el.FICHA_CLIENTE_DOCUMENTOS.DTEMISSAO).should('have.value', '12/09/2005')

  cy.get(el.FICHA_CLIENTE_DOCUMENTOS.ORGAOEMISSOR, { timeout: 70000 }).click()
  cy.get('.mat-option-text').contains('MINISTERIO DA DEFESA', { timeout: 80000 }).click({ force: true })//orgãoEmissor 
  cy.get(el.FICHA_CLIENTE_DOCUMENTOS.ORGAOEMISSOR, { timeout: 70000 }).should('have.text', 'MINISTERIO DA DEFESA')

  //Dados Residenciais
  cy.get(el.FICHA_CLIENTE_DOCUMENTOS.NOME_MAE, { timeout: 70000 }).type('Paloma Lima Santos')
  ...
  cy.get(el.FICHA_CLIENTE_RESIDENCIAIS.NUMERO, { timeout: 70000 }).should('be.visible').type('601')
  cy.get(el.FICHA_CLIENTE_RESIDENCIAIS.NUMERO, { timeout: 70000 }).should('have.value', '601')

  cy.wait(3000)
  //Dados Profissionais
  cy.get(el.FICHA_DADOS_PROFISSIONAIS.DADOS_PROFISSIONAIS, { timeout: 70000 }).should('be.visible').click({ force: true })

  cy.get(el.FICHA_DADOS_PROFISSIONAIS.NOME_EMPRESA, { timeout: 70000 }).type('BBTS Associados', { force: true })//nome da empresa
  // pais do documento
  ...
  cy.get(el.FICHA_DADOS_PROFISSIONAIS.PATRIMONIO, { timeout: 70000 }).type('13000000', { force: true })//CampPatrimonio
  cy.get(el.FICHA_DADOS_PROFISSIONAIS.RENDAM, { timeout: 70000 }).type('1800000', { force: true })//Renda Mensal
  cy.get(el.FICHA_DADOS_PROFISSIONAIS.OVALORES, { timeout: 70000 }).type('1100000', { force: true })//outros valores

  cy.get(el.FICHA_DADOS_PROFISSIONAIS.TELCOMERCIAL, { timeout: 80000 }).type('61 2228-3357', { force: true })

  cy.contains(el.FICHA_DADOS_VEICULO.DADOS, { timeout: 80000 }).click({ force: true })//Aba dados do Veiculo
  cy.get(el.FICHA_DADOS_VEICULO.CHASSI, { timeout: 80000 }).should('be.visible').type('93Y RBB008 NJ 089055 ', { force: true })
  cy.get(el.FICHA_DADOS_VEICULO.PLACA, { timeout: 80000 }).should('be.visible').type('JEQ-0765', { force: true })
  ...
  cy.get('.mat-option-text').contains('Cinza', { timeout: 80000 }).click({ force: true })
  //Kilometragem
  ...
  cy.get(el.AVALISTA_1.CAMPO_NOME, { timeout: 80000 }).type('Cristina Lemos Paes', { force: true }).should('have.value', 'Cristina Lemos Paes')

  cy.get(el.AVALISTA_1.CPF, { timeout: 80000 })
    .type('037.247.510-87', { force: true }).should('have.value', '037.247.510-87')

  cy.xpath(el.AVALISTA_1.DTNASCIMENTO, { timeout: 80000 }).type('01/05/1992{Esc}').should('have.value', '01/05/1992')

  cy.xpath(el.AVALISTA_1.CAMPO_EMAIL, { timeout: 80000 }).type('cl.paes@gmail.com').should('have.value', 'cl.paes@gmail.com')

  cy.get(el.AVALISTA_1.TEL_RESIDENCIAL, { timeout: 80000 })
    .type('6136102093', { force: true }).should('have.value', '(61) 3610-2093')

  cy.xpath(el.AVALISTA_1.CELULAR, { timeout: 80000 })
    .type('61992685018').should('have.value', '(61) 9 9268-5018')
  ...
  cy.get(el.AVALISTA_1.NOME_CONJUGUE, { timeout: 80000 })
    .type('Gilberto Soares Neto', { force: true })
    .should('have.value', 'Gilberto Soares Neto')
  ...
  cy.get(el.AVALISTA_1.DATA_DE_EMISSAO).type('18/08/1999{Esc}')
  ...
  cy.get(el.AVALISTA_1.NOME_MAE).type('Lindalva Mendes Couto')
  .should('have.value', 'Lindalva Mendes Couto')
  ...
  cy.get(el.AVALISTA_1.NUMERO_ENDERECO, { timeout: 80000 }).type('101', { force: true }).should('have.value', '101')
