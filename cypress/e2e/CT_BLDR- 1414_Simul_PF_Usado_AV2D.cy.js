...
it('CT Simulação Veiculo Usado Com 2 Avalistas', () => {
  ...
  cy.get(el.CLIENTE.DTNASCIMENTO).type('10/01/1985{Esc}').should('have.value', '10/01/1985')

  cy.get(el.CLIENTE.CAMPO_TEL).type('61998260305').should('have.value', '(61) 9 9826-0305')
  ...
  .type('70713-000{enter}')

  cy.get(el.CLIENTE.CAMPO_CEP).should('have.value', '70713-000')

  cy.wait(3000)
  cy.get(el.CLIENTE.BTN_CONTINUAR).should('to.visible').click()
  // cy.wait(3000)
  ...
  cy.get(el.SIMULACAO.ENTRADA_CARD1, { timeout: 80000 }).should('be.visible').clear().type('78,00')
  ...
  cy.get(el.SIMULACAO.SEMINOVO_GARANTIDO_COMPLETO_KM).type('80000').type('{enter}')
  ...
  cy.get(el.FICHA_CLIENTE.DP_CAMPO_CONJUGUE).type('Bruna Rodrigues Fontes')

  // CPFouCNPJ do Conjuguê
  cy.get(el.FICHA_CLIENTE.DP_CPFCONJUGUE).type('00166073091')
  ...
  cy.get(el.FICHA_CLIENTE_DOCUMENTOS.NRG, { timeout: 70000 })//rg
    .click({ force: true })
    .type('405832187').should('have.value', '405832187')
  ...
  //Dados Residenciais
  cy.get(el.FICHA_CLIENTE_DOCUMENTOS.NOME_MAE, { timeout: 70000 }).type('Maria Moura Rodrigues')
  ...
  cy.get(el.FICHA_CLIENTE_RESIDENCIAIS.NUMERO, { timeout: 70000 }).should('be.visible').type('603')
  cy.get(el.FICHA_CLIENTE_RESIDENCIAIS.NUMERO, { timeout: 70000 }).should('have.value', '603')

  cy.wait(3000)
  //Dados Profissionais
  cy.get(el.FICHA_DADOS_PROFISSIONAIS.DADOS_PROFISSIONAIS, { timeout: 70000 }).should('be.visible').click({ force: true })

  cy.get(el.FICHA_DADOS_PROFISSIONAIS.NOME_EMPRESA, { timeout: 70000 }).type('MG3 Group', { force: true })//nome da empresa
  // pais do documento
  ...
  cy.get(el.FICHA_DADOS_VEICULO.CHASSI, { timeout: 80000 }).should('be.visible').type('93Y9SR8V6PJ349934', { force: true })
  cy.get(el.FICHA_DADOS_VEICULO.PLACA, { timeout: 80000 }).should('be.visible').type('BGC2496', { force: true })
  ...
  cy.get(el.AVALISTA_1.CAMPO_NOME, { timeout: 80000 }).type('Emilly da Paz Solto Maior', { force: true }).should('have.value', 'Emilly da Paz Solto Maior')

  cy.get(el.AVALISTA_1.CPF, { timeout: 80000 })
  .type('224.671.871-60', { force: true }).should('have.value', '224.671.871-60')

  cy.xpath(el.AVALISTA_1.DTNASCIMENTO, { timeout: 80000 }).type('01/05/1985{Esc}').should('have.value', '01/05/1985')

  cy.xpath(el.AVALISTA_1.CAMPO_EMAIL, { timeout: 80000 }).type('epsoltomaior@gmail.com').should('have.value', 'epsoltomaior@gmail.com')
  ...
  cy.get('.mat-option-text').contains('COMPANHEIRO', { timeout: 80000 }).click({ force: true })
  ...
  cy.get(el.AVALISTA_1.NOME_MAE).type('Maria Neiva Gomes')
    .should('have.value', 'Maria Neiva Gomes')
  ...
  cy.get(el.AVALISTA_1.NUMERO_ENDERECO, { timeout: 80000 }).type('1001', { force: true }).should('have.value', '1001')
  //   cy.wait(2000)

  //Dados Profissionais
  cy.contains(el.AVALISTA_1.DADOS_PROFISSIONAIS, { timeout: 70000 }).should('be.visible').click({ force: true })

  cy.get(el.AVALISTA_1.NOME_DA_EMPRESA, { timeout: 70000 }).type('Investir Associados', { force: true })//nome da empresa
  ...
  cy.get('.mat-option-text').contains('ECONOMISTA').click({ force: true })
  cy.get(el.AVALISTA_1.CARGO, { timeout: 70000 }).should('contain', 'ECONOMISTA')
  ...
  cy.get(el.AVALISTA_1.TEL_COMERCIAL, { timeout: 80000 }).type('11 36290102', { force: true }).should('have.value', '(11 3629-0102')
  ...
  cy.get('.mat-option-text').contains('DIVORCIADO', { timeout: 80000 }).click({ force: true })
  cy.xpath(el.AVALISTA_2.ESTADO_CIVIL, { timeout: 80000 })
    .should('contain', 'DIVORCIADO')
 ...
 // .should('have.value', '799.178.770-29')
  ...
  cy.get(el.AVALISTA_2.NOME_DA_EMPRESA, { timeout: 70000 }).type('Neo Investimentos', { force: true })//nome da empresa
  ...
  cy.get(el.AVALISTA_2.PATRIMONIO, { timeout: 70000 }).type('10000000', { force: true }).should('have.value', 'R$ 10.000,00')

  cy.get(el.AVALISTA_2.RENDA_MENSAL, { timeout: 70000 }).type('1300000', { force: true }).should('have.value', 'R$ 13.000,00')//Renda Mensal

  cy.get(el.AVALISTA_2.OUTROS_VALORES, { timeout: 70000 }).type('1100000', { force: true }).should('have.value', 'R$ 11.000,00')//outros valores

  cy.get(el.AVALISTA_2.TEL_COMERCIAL, { timeout: 80000 }).type('11 32350102', { force: true }).should('have.value', '(11) 3235-0102')
